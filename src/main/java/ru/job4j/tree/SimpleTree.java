...
public class SimpleTree<E> implements Tree<E> {
    ...
    public boolean add(E parent, E child) {
        ...
        Optional<Node<E>> childOptionalNode = findBy(child);
        boolean rsl = childOptionalNode.isEmpty() && parentOptionalNode.isPresent();
        if (rsl) {
            Node<E> parentNode = parentOptionalNode.get();
